        ...
        <section class="page-banner-area pt-200 rpt-140 pb-100 rpb-60 rel z-1 text-center">
            <div class="container">
                <div class="banner-inner text-white">
                    <h1 class="page-title wow fadeInUp delay-0-2s">Liste des Pprojets</h1>
        ...
        <section class="projects-area pt-40 pb-130 rpb-100 rel z-1">
            <div class="container">
               <ul class="project-filter filter-btns-one justify-content-center pb-35 wow fadeInUp delay-0-2s">
                    <li data-filter="*" class="current">Voir tout</li>
                    @foreach ($services as $service)
                        <li data-filter="{{ ".$service->tag" }}">{{ $service->tag }}</li>
                    @endforeach
                ...
                <div class="row project-masonry-active">
                    ...
                    <div class="col-lg-6 item {{ $project->service_tag }}">
                    ...
                    <div class="text-center">
                        <span>Aucun projet diposnible</span>
                    </div>
                    @endforelse
