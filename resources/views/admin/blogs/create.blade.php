...
@section('content')
    <div class="row">
        <div class="col-12">
            <h2 class="mb-4" style="color: var(--admin-text-heading);">Rédaction d'un article</h2>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                <div class="admin-card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-editor" id="content" name="content" rows="15"
            ...
            <div class="col-lg-4">
                ...
                <div class="admin-card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tags" name="tags" placeholder="Figma, React, UI/UX">
